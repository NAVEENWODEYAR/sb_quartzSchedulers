 ...
 * org.springframework.boot.autoconfigure.quartz.QuartzDataSource; import
 ...
 *//**
	 ...
	 *//*
		 ...
		 * @Configuration
		 * 
		 * @EnableAutoConfiguration public class QuartzConfiguration {
		 * 
		 * @Bean
		 * 
		 * @QuartzDataSource
		 ...
		 * quartzDataSource(){ return DataSourceBuilder.create().build(); }
		 * 
		 * }
		 */